...
*/
float imgStrategic(ImgFunType funtype, IplImage* imgprev, IplImage* imgcurr, IplImage* imgdst, Mat &color, Mat &gray, int strategic = 1);
...
*/
float matStrategic(MatFunType funtype, Mat frameprev, Mat framecurr, Mat &framedst,Mat &color, Mat &gray, int strategic = 1, bool issf = false);
